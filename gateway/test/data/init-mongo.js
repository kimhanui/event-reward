module.exports = async function initMongo() {
	...
	const event_id= new ObjectId('665a2234567890abcdef5678')
	const reward_id= new ObjectId('665a3334567890abcdef9999')
	const reward_id2= new ObjectId('665a3334567890abcdef9998')
	...
	await db.events.insertOne([
		{
			...
			"title": "이벤트1",
			"content": "테스트",
			"start_dt": "2025-05-18T00:00:0Z",
			"end_dt": "",
			"active_yn": true,
			"reward_manual_yn": false,
			"conditions": ["{\"user_id\": '%s', \"check_cnt\": {\"%gte\" : 3}}"],
			"reward_ids": [reward_id, reward_id2],
		}
	]);
	...
	await db.userattendances.insertOne({
		user_id: "aaaa",
		last_check_dt: "2025-05-21T00:00:0Z",
		check_cnt: 3,
	})
